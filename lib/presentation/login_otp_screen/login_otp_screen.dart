...
class LoginOtpScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => LoginOtpProvider(), child: LoginOtpScreen());
  }
}
            ...
            body: Container(
                ...
                child: Column(children: [
                  ...
                  Padding(
                      ...
                      child: Selector<LoginOtpProvider, TextEditingController?>(
                              ...
                              text: TextSpan(children: [
                                TextSpan(
                                    ...
                                    style: CustomTextStyles
                                        .titleSmallPoppinsff000000),
                                TextSpan(
                                    text: "lbl_resend".tr,
                                    style: CustomTextStyles
                                        .titleSmallPoppinsffff9134)
                              ]),
