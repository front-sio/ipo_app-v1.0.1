...
class LoginScreenState extends State<LoginScreen> {
              ...
              child: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      width: double.maxFinite,
                      padding: EdgeInsets.symmetric(horizontal: 23.h, vertical: 54.v),
                      ...
                      child: Column(
                        ...
                        children: [
                          Text("msg_enter_your_number".tr, style: CustomTextStyles.titleLargeRoboto),
                          ...
                          Text("lbl_or".tr, style: CustomTextStyles.titleSmallRoboto14),
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                ...
                                style: CustomTextStyles.labelLargeRobotoGray900,
                              ),
                            ),
                          ),
                          SizedBox(height: 44.v),
      ...
      child: Consumer<LoginProvider>(
        builder: (context, provider, child) {
          return CustomPhoneNumber(
            country: provider.selectedCountry ?? CountryPickerUtils.getCountryByPhoneCode('1'),
  ...
  Widget _buildSignInButton(BuildContext context) {
    return CustomElevatedButton(
      ...
      onPressed: () {
        Provider.of<LoginProvider>(context, listen: false).checkPhoneNumberExists(context);
      },
    );
  }
  ...
  void onTapSignInWithGoogleButton(BuildContext context) async {
  ...
  void onTapSignInWithFacebookButton(BuildContext context) async {
